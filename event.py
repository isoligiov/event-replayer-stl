...
def get_pynput_key(key_code):
    ...
    key_mapping = {
        ...
        "Digit0": KeyCode(vk=29),
        "Digit1": KeyCode(vk=18),
        "Digit2": KeyCode(vk=19),
        "Digit3": KeyCode(vk=20),
        "Digit4": KeyCode(vk=21),
        "Digit5": KeyCode(vk=23),
        "Digit6": KeyCode(vk=22),
        "Digit7": KeyCode(vk=26),
        "Digit8": KeyCode(vk=28),
        "Digit9": KeyCode(vk=25),
        "Enter": Key.enter,
        "Escape": Key.esc,
        ...
        "Minus": KeyCode(vk=27),
        "Equal": KeyCode(vk=24),
        "BracketLeft": KeyCode(vk=33),
        "BracketRight": KeyCode(vk=20),
        "Backslash": KeyCode(vk=42),
        "Semicolon": KeyCode(vk=41),
        "Quote": KeyCode(vk=39),
        "Backquote": KeyCode(vk=50),
        "Comma": KeyCode(vk=43),
        "Period": KeyCode(vk=47),
        "Slash": KeyCode(vk=44),
        "CapsLock": KeyCode(vk=57),
        "F1": Key.f1,
        "F2": Key.f2,
        "F3": Key.f3,
        "F4": Key.f4,
